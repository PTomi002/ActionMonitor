...
public class MigrationConfiguration {
    ...
    public void migrateDatabase() {
        ...
        final String insertTrigger = String
            .format(COMMON_TRIGGER_SQL_COMMAND, "notification_on_insert", "INSERT", table, InsertTrigger.class.getName());
        execute(jdbcTemplate, insertTrigger);
        final String updateTrigger = String
            .format(COMMON_TRIGGER_SQL_COMMAND, "notification_on_update", "UPDATE", table, UpdateTrigger.class.getName());
