...
public class TimeSeriesControllerTest {
  ...
  public void testInsertTimeSeriesData() throws Exception {
    ...
    final MvcResult mvcResult = mockMvc.perform(
        post(BASE_URL).content(objectMapper.writeValueAsString(timeSeries))
  ...
  public void testDeleteTimeSeriesData() throws Exception {
    ...
    assertThat("The initial time series data should be deleted!", timeSeriesRepository.count(),
        is(0L));
  }
  ...
  public void testUpdateExistingTimeSeriesData() throws Exception {
    ...
    assertThat("The already existing time series data should be updated!",
        timeSeriesRepository.findOne(ID),
        is(timeSeries));
  }
  ...
  public void testUpdateNotExistingTimeSeriesData() throws Exception {
    ...
    assertNotNull("Not existing time series data should be saved into DB!",
